...
savePill: { display: "inline-flex", alignItems: "center", gap: 8, background: COLORS.primarySoft, borderRadius: 999, padding: "8px 12px", color: COLORS.primary, fontSize: 14 },
  ...
  th: { textAlign: "left", padding: 10, background: COLORS.primarySoft, borderBottom: `1px solid ${COLORS.border}`, position: "sticky", top: 0, color: COLORS.primary },
  td: { padding: 10, borderBottom: `1px solid ${COLORS.border}`, verticalAlign: "top", color: COLORS.text },
  tableInput: { width: 110, height: 34, borderRadius: 8, border: `1px solid ${COLORS.border}`, padding: "0 8px", background: COLORS.surface, color: COLORS.text },
  tableInputWide: { width: 140, height: 34, borderRadius: 8, border: `1px solid ${COLORS.border}`, padding: "0 8px", background: COLORS.surface, color: COLORS.text },
};
